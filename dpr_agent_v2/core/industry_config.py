...
class _ApplicabilityShim:
    """
    Backward-compatibility shim.
    Allows old code using profile.applicability.has_X to keep working
    by delegating to profile.flags.
    """
    def __init__(self, flags):
        self._f = flags

    @property
    def has_rm_cost(self):       return bool(self._f.rm_cogs)
    @property
    def has_raw_materials(self): return bool(self._f.raw_materials)
    @property
    def has_wip(self):           return bool(self._f.wip)
    @property
    def has_cold_store(self):    return bool(self._f.cold_store)
    @property
    def has_finished_goods(self):return bool(self._f.finished_goods)
    @property
    def has_transport(self):     return bool(self._f.transport)
    @property
    def has_power_cost(self):    return bool(self._f.power)
    @property
    def has_drawings(self):      return bool(self._f.drawings)
    @property
    def has_intangibles(self):   return bool(self._f.intangibles)
    @property
    def has_security_dep(self):  return bool(self._f.security_deposits)
...
class IndustryProfile:
    ...
    def applicability(self):
        """Backward-compat: allows profile.applicability.has_rm_cost etc."""
        return _ApplicabilityShim(self.flags)
